...
import Storage.RealTime.GameEnvironment.*;
...
public final class StorageFacade {
    ...
    public static GameData loadGameData() {
        return (mode==Mode.LOCAL) ? GameDataStorage.LoadGameData()
                : remote.loadGameData();
    }
    ...
    public static void saveGameData(GameData v) {
        if (mode==Mode.LOCAL) GameDataStorage.SaveGameData(v);
        else remote.saveGameData(v);
    }
}
