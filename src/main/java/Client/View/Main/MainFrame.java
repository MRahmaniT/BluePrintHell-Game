...
import Client.View.LoginPage.LoginPanel;
import Client.View.MenuPage.MenuPanel;
import Client.View.GamePage.GamePanel;
import Client.View.LevelPage.LevelPanel;
import Client.Services.AudioManager;
import Client.View.SettingsPage.SettingsPanel;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame(){
        ...
        //Add Client.Main Frame to Client.Main Panel
        add(mainPanel);
    }
